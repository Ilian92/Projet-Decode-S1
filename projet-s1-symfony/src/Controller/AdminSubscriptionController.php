...
final class AdminSubscriptionController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_subscription/new.html.twig', [
    ...
    {
        return $this->render('admin_subscription/show.html.twig', [
            'subscription' => $subscription,
        ]);
    }
    ...
    public function edit(Request $request, Subscription $subscription, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_subscription/edit.html.twig', [
            'subscription' => $subscription,
            'form' => $form,
        ]);
    }
